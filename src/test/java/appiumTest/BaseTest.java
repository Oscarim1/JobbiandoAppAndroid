...
public class BaseTest {
	...
	public void funcionScrollHorizontal(Double width_start, Double width_end, Double height)
	...
	public String elementExistSolicitud(Integer n) {
		try {
			By elemento = By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget"
					...
					+ ".ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[" + n
					+ "]/android.view"
